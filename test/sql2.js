...
module.exports = {
    ...
    frstList : {
        query: "SELECT * FROM NEWS.tbl_frst WHERE (city1='부산광역시' or city1='울산광역시' or city1='경상남도') and tmfrst > date_format(date_add(now(),interval +9 hour),'%Y-%m-%d 00:00:00') order by tmfrst desc,datetime desc"
    },
    carsList : {
